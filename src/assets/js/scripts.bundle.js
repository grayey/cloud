...
var mApp = function () {
    ...
    (function ($) {
      ...
      $(document).on('click', function (e) {
        var thisThis = this;
        // .m-menu__nav .m-menu__item.m-menu__item--submenu.m-menu__item--hover:not(.m-menu__item--tabs)
        var sidebar$ = $('[data-menu-submenu-toggle="click"]');
        var element = $(this); // .closest('.m-menu__nav').parent();
        menu = element.mMenu();
        console.log('Yes mehn');
        console.log('sibars=', sidebar$);
     /*   sidebar$.each(function (i, el) {
          console.log(i, 'el=', el);
          if (el.classList.contains('m-menu__item--open')) {
            console.log('true==');
            el.classList.remove('m-menu__item--open');
          }
        });*/
